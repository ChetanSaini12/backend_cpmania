...
const atcoderContest = async (req, res) => {
    ...
    contests.each((index, element) => {
        ...
        const slug = pretty((curr("td:nth-child(2) a").attr('href')))
...
module.exports = {atcoderContest, codechefContest, codeforcesContest, leetCodeContest, fastforcesContest }